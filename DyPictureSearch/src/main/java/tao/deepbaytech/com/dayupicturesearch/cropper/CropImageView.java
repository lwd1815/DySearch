...
public class CropImageView extends FrameLayout {
  ...
  public void setXxBorderColor(boolean f){
    mCropOverlayView.setXxBorderColor(f);
  }

  public void setCornerOffset(int cornerOff) {
    mCropOverlayView.setCornerOffset(cornerOff);
  }

  public void drawOnlyBg(boolean f) {
    mCropOverlayView.drawOnlyBg(f);
  }

  public void setCropOverLayEnable(boolean isEnable) {
    mCropOverlayView.setEnabled(isEnable);
  }
